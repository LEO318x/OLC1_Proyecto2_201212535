...
func getDataPY(w http.ResponseWriter, r *http.Request){
	//Cabecera
	w.Header().Set("Content-Type", "application/json")
	//Obtenemos la información que nos envía el navegador a través de Ajax	
	r.ParseForm()
	...
	//URL para realizar la petición a nodejs
	url := "http://localhost:3030/traducirpy"
...
func main(){
	...
	http.HandleFunc("/traducirpy", getDataPY) //Ruta que nos sirve para realizar la petición entre go y nodejs
